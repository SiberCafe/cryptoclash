    ...
    <header className="relative flex items-center px-4 py-3 bg-black text-[#00FF41] justify-between font-['Playfair_Display']">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col">
          <h4 className="text-lg font-extrabold tracking-wide">School of Computer Science and Engineering (SCOPE)</h4> {/* Increased Font Size */}
        </div>
      </div>
      ...
      <div className="flex flex-1 justify-end">
        <DropdownMenu>
          ...
          <DropdownMenuContent
            align="end"
            sideOffset={8}
            className="w-64 bg-[#1A1A1A] border border-[#00FF41] rounded-md shadow-lg"
          >
            <DropdownMenuLabel className="text-[#00FF41] font-['Playfair_Display'] px-4 py-2 whitespace-nowrap">
                Logged in as <span className="font-bold">4xKOFFEE</span>
            </DropdownMenuLabel>
            ...
            <DropdownMenuItem
              ...
              className="text-red-500 flex items-center gap-2 hover:bg-[#FF3131] px-4 py-2 cursor-pointer transition-all duration-300 rounded-md" >
